                        ...
                        <div class="single-blog">
                            <div class="blog-content">
                                ...
                                <h6>by <?php echo $name;?> <span class="btn-mini">Follow</span></h6>
                                 ...
                                 <button id="joinEvent"  type="submit" class="btn btn-primary btn-circled" value="<?php echo $id; ?>" data="<?php echo $eventID; ?>">Join the Event</button>
                            </div>
                        </div>
                    </div>
                </div>
