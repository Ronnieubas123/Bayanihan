...
form.modalform  input,form.modalform select {
    border-radius: 5px;
    padding: 10px 20px;
    margin: 5px 0;
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <ul class="navbar-nav ">
                        ...
                        <li class="nav-item ">
                            <a href="../post/" class="nav-link js-scroll-trigger">
                                Home
                            </a>
                        </li>
                   
                        <li class="nav-item ">
                            <a href="shop.php" class="nav-link js-scroll-trigger">
                                Shop
                            </a>
                        </li>
                        <li class="nav-item ">
                ...
                <div class="col-md-12 col-lg-9">
                   <div class="banner-content2 text-center style-2">
                        ...
                        <h1 class="display-4 mb-4 ">
                            We dedicate ourselves to a common Goal
                        </h1>
   ...
   <section class="section" id="blog">
        <div class="container">
            ...
            <div class="row justify-content-center">
               <?php include"../../classes/viewPost.php"; ?>
            </div>
        </div>
    </section>
...
<script>
    $(function(){
        $(document).on("click","#viewP",function(){
            ...
            document.location.href = "viewpost.php?eventID=" + eventID;
        });
    });
</script>